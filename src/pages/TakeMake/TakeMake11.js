  ...
  return (
    <>
      ...
      <PageTemplate>
        ...
        <p><strong>Step 2</strong> - Take 1 more plain popsicle stick and the stick with the rubber gasket and and tie them together at the end without the gasket using one rubber band about a ½ inch from the end of the sticks. Make sure the gasket is facing out.</p>
        <img className="mx-auto" src={img02} alt="Step 2" />

        <p><strong>Step 3</strong> - Insert the big stack of popsicle sticks between the other two and push it up close to the rubber band end</p>
        ...
        <p><strong>Step 2</strong> - Take 4 popsicle sticks and set them up in a square with the ends crossed over. Tie each corner off with a rubber band.</p>
        <img className="mx-auto" src={img05} alt="Step 5" />

        <p><strong>Step 3</strong> - Attached the Vs from step 1 to the square in step two with a few more rubber bands at the corners. This is your catapult base.</p>
        <img className="mx-auto" src={img06} alt="Step 6" />

        <p><strong>Step 4</strong> - Place 1 popsicle stick across the top of the catapult base and one across the bottom. Tie them on with rubber bands.</p>
        <img className="mx-auto" src={img07} alt="Step 7" />

        <p><strong>Step 5</strong> - Weave the the popsicle stick with the gasket through the sticks you placed in step 4. Place the rubber band around the base of the gasket stick and around the far corners of the base.</p>
